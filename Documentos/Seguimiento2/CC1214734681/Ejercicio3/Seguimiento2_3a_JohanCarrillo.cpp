...
//Prototypes
void ReadBytes( ifstream&, long, long );
...
int main(){
	...
	ReadBytes(inFile, first_char, n_read);
...
void ReadBytes(ifstream& inFile, long first_char, long n_read){
	// This function reads from a file n_read chars starting from first_read, and 
	// show them in screen 
